  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-turquoise-50 to-turquoise-100">
      <div className="text-center">
        <h2 className="text-4xl font-bold text-turquoise-950 mb-4">Something went wrong!</h2>
        <p className="text-lg text-turquoise-900 mb-8">{error?.message || "An unexpected error occurred"}</p>
        <button
          onClick={reset}
